...
export default class StockInMLotProperties extends MobileProperties{

    static displayName = 'StockInMLotProperties';
    ...
    handleSubmit = () => {
        ...
        MobileRequest.sendStockInRequest(requestObject);
    }
