 ...
 * 打印荣耀外箱标签
 */
export default class VcPrintRYBoxLabelProperties extends EntityViewProperties{

    static displayName = 'VcPrintRYBoxLabelProperties';
    ...
    queryData = (whereClause) => {
        ...
        VcPrintParameterRequest.sendGetRYBoxParaRequest(object);
    }
    ...
    createAdvancedPrintButton = () => {
        return <AuthorityButton key="AdvancedPrintRYBoxMLotBtn" name="AdvancedPrintRYBoxMLotBtn" 
