...
import COBReceiveFGScanTable from "../../../components/Table/gc/COBReceiveFGScanTable";

const rowKey = "packedLotRrn";

export default class COBFinishGoodScanProperties extends EntityScanProperties{

    static displayName = 'COBFinishGoodScanProperties';
    ...
    buildTable = () => {
        return <COBReceiveFGScanTable pagination={false} rowKey={this.state.rowKey} 
