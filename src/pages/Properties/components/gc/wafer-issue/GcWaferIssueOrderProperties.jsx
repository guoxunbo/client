...
import GcWaferIssueMLotUnitScanProperties from "./GcWaferIssueMLotUnitScanProperties";
// import GcWaferReceiveOrderMLotUnitProperties from "./GcWaferReceiveOrderMLotUnitProperties";

export default class GcWaferIssueOrderProperties extends EntityProperties{

    static displayName = 'GcWaferIssueOrderProperties';
    ...
    buildOtherComponent = () => {
        return <GcWaferIssueMLotUnitScanProperties orderTable={this.orderTable} tableRrn={99122} resetFlag={this.state.resetFlag} onSearch={this.getTableData.bind(this)}/>
    }
