...
import GcWaitPurchaseOutsoureReceiveProperties from "./GcWaitPurchaseOutsoureReceiveProperties";
import GcPurchaseOutsoureReceiveMLotUnitTable from "../../../components/Table/gc/GcPurchaseOutsoureReceiveMLotUnitTable";

export default class GcPurchaseOutsoureReceiveProperties extends EntityScanProperties{

    static displayName = 'GcPurchaseOutsoureReceiveProperties';
    ...
    queryData = (whereClause) => {
        ...
        let waitForReceiveMLotUnitList = this.waitPurchaseOutsoureReceiveProperties.state.tableData;
        let requestObject = {
    ...
    buildTable = () => {
        return <GcPurchaseOutsoureReceiveMLotUnitTable pagination={false} 
