...
import HKPackMaterialLotTable from "../../../components/Table/gc/HKPackMaterialLotTable";

const PackageType = "HKPackCase";

export default class HKPackMaterialLotProperties extends EntityScanProperties{

    static displayName = 'HKPackMaterialLotProperties';
    ...
    buildTable = () => {
        return <HKPackMaterialLotTable pagination={false} 
