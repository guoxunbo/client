...
import GCMLotCodePackCheckTable from "../../../components/Table/gc/GCMLotCodePackCheckTable";

/**
 * GC 物料编码装箱检验
 * 记录在物料批次上一个属性栏位即可。
 */
export default class GCMLotCodePackCheckProperties extends EntityDoubleScanProperties{

    static displayName = 'GCMLotCodePackCheckProperties';
    ...
    buildTable = () => {
        return <GCMLotCodePackCheckTable checkItemList={this.state.judgePackCaseItemList} pagination={false} 
