...
import GcRawMaterialReceiveTable from "../../../components/Table/gc/GcRawMaterialReceiveTable";
import GcWaitReceiveRawMaterialProperties from "./GcWaitReceiveRawMaterialProperties";

export default class GcRawMaterialReceiveProperties extends EntityScanProperties{

    static displayName = 'GcRawMaterialReceiveProperties';
    ...
    queryData = (whereClause) => {
        ...
        let waitForReceiveMLotUnitList = this.waitReceiveRawMaterial.state.tableData;
        let requestObject = {
    ...
    buildTable = () => {
        return <GcRawMaterialReceiveTable pagination={false} 
