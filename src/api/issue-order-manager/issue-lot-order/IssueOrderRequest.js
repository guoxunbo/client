...
export default class IssueOrderRequest {
    ...
    static sendCreateIssueMLotOrderRequest= (object) => {
        let requestBody =  IssueOrderRequestBody.buildCreateIssueMLotOrder(object.materialLots,object.materialLots.actionReason,object.materialLots.actionComment);
        let requestHeader = new IssueOrderRequestHeader();
