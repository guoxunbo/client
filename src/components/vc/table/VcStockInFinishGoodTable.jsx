...
import VcStockInFinishGoodDialog, { ActionType } from '@components/vc/dialog/VcStockInFinishGoodDialog';
...
export default class VcStockInFinishGoodTable extends EntityScanViewTable {

    static displayName = 'VcStockInFinishGoodTable';
  ...
  createForm = () => {
      return  <VcStockInFinishGoodDialog action={ActionType.StockIn} ref={this.formRef} object={this.state.data} visible={this.state.formVisible} 
