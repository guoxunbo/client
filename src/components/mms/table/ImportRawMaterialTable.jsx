...
export default class ImportRawMaterialTable extends CsvImportTable {

    static displayName = 'ImportRawMaterialTable';
    ...
    SaveButton = () => {
        ...
        CsvImportRequest.sendSaveRawMaterialRequest(requestObject);
    }
