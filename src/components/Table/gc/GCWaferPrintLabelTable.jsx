...
export default class GCWaferPrintLabelTable extends EntityListTable {

    static displayName = 'GCWaferPrintLabelTable';
    ...
    printLable = () => { 
        ...
        if (data && data.length > 0) {
            ...
            GetPrintWltVboxParameterRequest.printWaferLabel(requestObject);
        }
