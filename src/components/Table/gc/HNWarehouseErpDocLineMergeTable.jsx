...
export default class HNWarehouseErpDocLineMergeTable extends EntityListCheckTable {

    static displayName = 'HNWarehouseErpDocLineMergeTable';
    ...
    mergeDocLine = () => {
        ...
        ErpDocLineMergeManagerRequest.sendHNWarehouseMergeDocRequest(requestObject);
    }
