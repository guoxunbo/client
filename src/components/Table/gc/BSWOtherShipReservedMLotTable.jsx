 ...
 * 保税仓 其他出备货表格
 */
export default class BSWCOMReservedMLotTable extends EntityListCheckTable {

    static displayName = 'BSWCOMReservedMLotTable';
    ...
    reserved = () => {
        ...
        ReservedManagerRequest.sendBSWOtherShipReserved(requestObj);
    }
