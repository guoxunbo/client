 ...
 * FT来料接收
 */
export default class GcFTMaterialLotReceiveTable extends EntityScanViewTable {

    static displayName = 'GcFTMaterialLotReceiveTable';
    ...
    createReceive = () => {
        return <Button key="receive" type="primary" 
                       ...
                       icon="plus" onClick={this.ftUnitReceive}>
