...
export default class BSWErpDocLineMergeTable extends EntityListCheckTable {

    static displayName = 'BSWErpDocLineMergeTable';
    ...
    mergeDocLine = () => {
        ...
        ErpDocLineMergeManagerRequest.sendBSWMergeDocRequest(requestObject);
    }
