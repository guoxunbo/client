...
export default class GcFTOutOrderIssueTable extends EntityScanViewTable {

    static displayName = 'GcFTOutOrderIssueTable';
    ...
    ftUnitIssue = () => {
        ...
        FtMLotManagerRequest.sendOutOrderUnitIssueRequest(requestObject);
    }
