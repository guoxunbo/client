...
export default class HNWarehouseOtherShipReservedOrderTable extends EntityListTable {

    static displayName = 'HNWarehouseOtherShipReservedOrderTable';
    ...
    selectRow = (record) => {
        ...
        ReservedManagerRequest.sendHNWarehouseGetOtherShipReservedMLot(object);
    }
