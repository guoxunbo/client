...
class QuestionLineTabTable extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      table:{},
  ...
  save(form, rowData) {
    form.validateFields((error, record) => {
      ...
      let object = {
        values: rowData,
        success: function(responseBody) {
          let responseData = responseBody.questionLine;
          let dataIndex = -1;
      ...
      QuestionLineRequest.sendMergeRequest(object);
    });
  }
...
export default Form.create()(QuestionLineTabTable);

QuestionLineTabTable.prototypes = {
